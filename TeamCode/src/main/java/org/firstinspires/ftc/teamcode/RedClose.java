    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //arm up
                ...
                if ((headingError <= 0.15 && headingError >= -0.15 && newTime - oldTime >= 1.3) || newTime - oldTime >= 1.75){
                    move10 = false;
                    servo0.setPower(0);
                    motor0.setPower(0);
                    motor1.setPower(0);
                ...
                if ((headingError <= 0.15 && headingError >= -0.15 && newTime - oldTime >= 1.4) || newTime - oldTime >= 1.8){
                    moveStrafe = false;
                    motor0.setPower(0);
                    motor1.setPower(0);
                    motor2.setPower(0);
                ...
                if(!left){
                    ...
                    if (headingError <= 0.15 && headingError >= -0.15 || newTime - oldTime >= 0.785){
                        turnCenter = false;
                        move13 = true;
                        motor0.setPower(0);
                        motor1.setPower(0);
